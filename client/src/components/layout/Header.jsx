...
const Header = ({ onOpenAuthModal, onOpenFavorites, onOpenDashboardChoice }) => {
  ...
  const isCustodian = userProfile?.role?.toLowerCase() === 'custodian';
        ...
        <div className="actions">
          {isAuthenticated ? (
            <>
              ...
              <Link to={isCustodian ? '/custodian-dashboard' : '/dashboard'} className="user-profile" style={{ textDecoration: 'none' }}>
                <img 
